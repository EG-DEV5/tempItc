...
router.get('/getAllTrainers', authenticateUser, authorizeRoles('admin'), getAllTrainers)
router.get('/getAllSafetyAdvisor', authenticateUser, authorizeRoles('admin'), getAllSafetyAdvisor)
router.get('/CustodyDetails/:id', authenticateUser, authorizeRoles('admin'), CustodyDetails)
router.get('/getCustodyByCity', authenticateUser, authorizeRoles('admin'), getCustodyByCity)
router.get(
  '/getallCustodys',
  authenticateUser,
...
router.get('/getCities', authenticateUser, authorizeRoles('admin', 'safety-advisor'), getAllCities)
...
router.post('/addRequest', authenticateUser, authorizeRoles('admin', 'safety-advisor'), addRequest)
router.post(
  '/resForRequest',
  authenticateUser,
  authorizeRoles('admin', 'safety-advisor'),
